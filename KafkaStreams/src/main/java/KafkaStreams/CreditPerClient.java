...
//                tablecurrency.join(tablecredito, (value1, value2) -> new Pair<Value1,Value2>(value1,value2));
    ...
    public static double getValue(String jsonString)
    {
        ...
        CreditsDTO creditsDTO = gson.fromJson(jsonString,CreditsDTO.class);
        return creditsDTO.getValueofcredit() + (creditsDTO.getValueofcredit()*creditsDTO.getExchangeRate());
    }
}
